...
params.cgf_outdir =  "${params.main_outdir}/fastas"
params.idc_outdir =  "${params.main_outdir}/identifications"
params.sir_outdir =  "${params.main_outdir}/statistics"

// Set Parameters, since we use a FASTA generated with ProtGraph
...
include {create_global_fasta} from PROJECT_DIR + '/create_global_fasta.nf'
